...
class CreateUserRequestUseCase{
  ...
  Future<ResultType<List<CreateUserRequestResponse>, ErrorEntity>> execute({required List<GetUserAmountRequest> requests, required XCsrfTokenResponse token,}) async {
    return repository.createUserRequest(requests: requests, token: token);
  }
