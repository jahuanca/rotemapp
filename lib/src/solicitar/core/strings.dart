...
const String isNewDetailParameter = 'isNewDetailParameter';
const String sentFromApprovePageParameter = 'sentFromApprovePageParameter';

const String valorBuscadoId = 'valorBuscadoId';
const String contentId = 'contentId';
const String listadoId = 'listadoId';
...
const String codeRechazada = 'R';
const String codeCompleta = 'C';
